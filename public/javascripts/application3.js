...
function createMarca() {
 ...
 // Create new marca in the invoice via ajax
  ...
  // Shortcut to create new customer form
  function createOrdenItem() {
    var orden_id = $("#orden_id").val();
    
    $.get('/ordens/new/' + orden_id + '/orden_products/new'+ '?ajax=1', {
    },
    function(data) {
      displayRemote(data);
      showRemote();
      
      $("#new_orden").bind("submit", function() {
        event.preventDefault();
        doCreateOrdenItem();
      });
    });
  ...
  // Create new customer in the invoice via ajax
  function doCreateOrdenItem() {
    var company_id = $("#orden_company_id").val();
    var name = $("#orden_name").val();
    var email = $("#orden_email").val();
    var account = $("#orden_account").val();
    var phone1 = $("#orden_phone1").val();
    var phone2 = $("#orden_phone2").val();
    var address1 = $("#orden_address1").val();
    var address2 = $("#orden_address2").val();
    var city = $("#orden_city").val();
    var state = $("#orden_state").val();
    var zip = $("#orden_zip").val();
    var country = $("#orden_country").val();
    var comments = $("#customer_comments").val();
