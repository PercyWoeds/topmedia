class CustomerContactsController < ApplicationController
  ...
  private
    ...
    def customer_contact_params
      params.require(:customer_contact).permit(:code, :name, :cargo, :telefono1, :telefono2, :telefono3, :anexo1, :anexo2, :anexo3, :celular1, :celular2, :celular3, :correo1, :correo2, :contacto_id, :user_id)
    end
end
