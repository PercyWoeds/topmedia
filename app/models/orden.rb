...
TABLE_HEADERS2 = ["Nº",
 ...
 def get_sumas(value)
  ...
  @orden =Orden.where(["fecha >= ? and fecha <= ? and customer_id=? and medio_id=? and secu_cont =? and moneda_id=? and month=? ", "#{fecha1} 00:00:00","#{fecha2} 23:59:59",customer,medio,secuencia,moneda,mes ]).order(:mount,:code )
    return @orden
end 
